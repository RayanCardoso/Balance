...
public class BalanceClassFixture : IClassFixture<CustomWebApplicationFactory>
{
    private readonly HttpClient _httpClient;

    public BalanceClassFixture(CustomWebApplicationFactory webApplicationFactory)
    {
